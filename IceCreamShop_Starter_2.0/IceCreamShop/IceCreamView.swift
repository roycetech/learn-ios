...
class IceCreamView: UIView {
  ...
  fileprivate let coneOuterColor = RGB(184, green: 104, blue: 50)
  fileprivate let coneInnerColor = RGB(209, green: 160, blue: 102)
  fileprivate let coneLaticeColor = RGB(235, green: 183, blue: 131)
  ...
  override func draw(_ frame: CGRect) {
    ...
    let iceCreamGradient = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: [iceCreamTopColor.cgColor, iceCreamBottomColor.cgColor], locations: [0, 1])
    ...
    conePath.move(to: CGPoint(x: frame.minX + 0.98284 * frame.width, y: frame.minY + 0.29579 * frame.height))
    conePath.addCurve(to: CGPoint(x: frame.minX + 0.49020 * frame.width, y: frame.minY + 0.35519 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.98284 * frame.width, y: frame.minY + 0.29579 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.72844 * frame.width, y: frame.minY + 0.35519 * frame.height))
    conePath.addCurve(to: CGPoint(x: frame.minX + 0.01225 * frame.width, y: frame.minY + 0.29579 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.25196 * frame.width, y: frame.minY + 0.35519 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.01225 * frame.width, y: frame.minY + 0.29579 * frame.height))
    ...
    lattice14Path.addCurve(to: CGPoint(x: frame.minX + 0.35784 * frame.width, y: frame.minY + 0.78465 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.36765 * frame.width, y: frame.minY + 0.78465 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.35784 * frame.width, y: frame.minY + 0.78465 * frame.height))
    coneLaticeColor.setStroke()
    ...
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.50000 * frame.width, y: frame.minY + 0.40099 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.43137 * frame.width, y: frame.minY + 0.35149 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.43137 * frame.width, y: frame.minY + 0.40099 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.58824 * frame.width, y: frame.minY + 0.35149 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.56863 * frame.width, y: frame.minY + 0.40099 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.54902 * frame.width, y: frame.minY + 0.35149 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.68627 * frame.width, y: frame.minY + 0.40099 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.62745 * frame.width, y: frame.minY + 0.35149 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.62745 * frame.width, y: frame.minY + 0.40099 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.78431 * frame.width, y: frame.minY + 0.33663 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.74510 * frame.width, y: frame.minY + 0.40099 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.74510 * frame.width, y: frame.minY + 0.33663 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.88235 * frame.width, y: frame.minY + 0.37129 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.82353 * frame.width, y: frame.minY + 0.33663 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.82353 * frame.width, y: frame.minY + 0.37129 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.99020 * frame.width, y: frame.minY + 0.30198 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.94118 * frame.width, y: frame.minY + 0.37129 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.99020 * frame.width, y: frame.minY + 0.31683 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.99020 * frame.width, y: frame.minY + 0.25248 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.99020 * frame.width, y: frame.minY + 0.28713 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.99020 * frame.width, y: frame.minY + 0.26967 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.50000 * frame.width, y: frame.minY + 0.00495 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.99020 * frame.width, y: frame.minY + 0.11577 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.77073 * frame.width, y: frame.minY + 0.00495 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.00980 * frame.width, y: frame.minY + 0.25248 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.22927 * frame.width, y: frame.minY + 0.00495 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.00980 * frame.width, y: frame.minY + 0.11577 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.00980 * frame.width, y: frame.minY + 0.30198 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.00980 * frame.width, y: frame.minY + 0.27047 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.00980 * frame.width, y: frame.minY + 0.28713 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.10784 * frame.width, y: frame.minY + 0.37624 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.00980 * frame.width, y: frame.minY + 0.31683 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.04902 * frame.width, y: frame.minY + 0.37624 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.19608 * frame.width, y: frame.minY + 0.33663 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.16667 * frame.width, y: frame.minY + 0.37624 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.15686 * frame.width, y: frame.minY + 0.33663 * frame.height))
    scoopPath.addCurve(to: CGPoint(x: frame.minX + 0.29412 * frame.width, y: frame.minY + 0.40099 * frame.height), controlPoint1: CGPoint(x: frame.minX + 0.23529 * frame.width, y: frame.minY + 0.33663 * frame.height), controlPoint2: CGPoint(x: frame.minX + 0.22549 * frame.width, y: frame.minY + 0.40099 * frame.height))
